...
Kirki::add_field('planeta_config', array(
	...
	'choices'				=> array(
		'none'						=> esc_html__('None (default)', 'planeta'),
		'planet-dark'			=> esc_html__('Planet Red (Dark)', 'planeta'),
		'planet-light'		=> esc_html__('Planet Red (Light)', 'planeta'),
	...
	'preset'      	=> array(
		'planet-light' 	=> array(
			'settings' 					=> array(
				...
				'page_title_background'				=> '#D50000',
				'menu_background'							=> array(
					'background-color'						=> '#FFFFFF',
				),
				'typography_main_color'				=> '#000000',
